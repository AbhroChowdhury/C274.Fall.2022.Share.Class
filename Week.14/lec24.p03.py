...
def main():
    ...
    # NOTE:  The following lines/versions are WRONG WRONG WRONG
    ...
    # print( norm[ "Dear" ] / float(norm_words) )
    # print( norm[ "Friend" ] / float(norm_words) )
    # print( ( norm[ "Dear" ] / float(norm_words) ) * ( norm[ "Friend" ] / float(norm_words) ) )
    # print( p_N * ( norm[ "Dear" ] / float(norm_words) ) * ( norm[ "Friend" ] / float(norm_words) ) )
